...
Analyze sales and revenue across product categories

Evaluate customer engagement based on subscription status
...
Explored purchase patterns across categories and age groups
...
Used cards, bar charts, donut charts, and line charts

Enabled dynamic filtering by:
...
A small segment of customers generates a significant portion of sales

Clothing and Accessories lead in both sales volume and revenue

Young Adults and Middle-Aged customers are the top revenue contributors

Line charts highlight revenue trends across product categories clearly
...
Helps businesses focus on customer retention strategies
